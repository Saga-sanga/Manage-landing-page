...
export default function HeaderNav() {
  ...
  return (
    <div className='px-4 absolute flex justify-center w-full'>
      <div onClick={handleClick} className={`${visibility} fixed w-screen h-screen modal-overlay scale-110 z-20`}></div>
      <nav className='flex relative justify-between items-center flex-grow max-w-6xl px-2 md:px-0 py-10 z-30'>
        <img className='w-28 md:w-auto' src={logo} alt="Manage Logo" />
